    ...
    <div class="flex justify-between items-center mb-4">
      ...
      <button id="addProductButton"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
          class="w-5 h-5 inline-block align-middle mr-2">
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <div class="mt-4">
                <form action="POST" method="/api/products" id="addProductForm" class="mb-4">
                  <input type="hidden" name="product_id" id="product_id_input" value="">
                  <!-- Hidden input for product ID when editing -->
                  <div class="mb-4">
                    <label class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2" for="product_name">
                      Product Name
                    </label>
                    <input
                      ...
                      id="product_name" name="product_name" type="text" placeholder="Enter product name" required />
                  </div>
                  <div class="mb-4">
                    ...
                    <textarea
                      class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-white dark:bg-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      id="description" name="description" placeholder="Enter product description" rows="3"
                      required></textarea>
                  </div>
                  <div class="mb-4">
                    ...
                    <div class="relative">
                      ...
                      <input
                        ...
                        id="price" name="price" type="number" step="0.01" placeholder="Enter price" required />
                    </div>
                  </div>
                  <div class="mb-4">
        ...
        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button id="modalAddProductButton"
